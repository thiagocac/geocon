...
export function DemoBanner() {
  ...
  return (
    <div className="fixed left-0 right-0 top-0 z-50 flex items-center justify-center gap-2 bg-gradient-to-r from-magenta via-purple to-navy py-1 text-center text-[11px] font-bold uppercase tracking-display text-white shadow-md">
